...
`cobol_packed` is best described as a packed-decimal codec plus a Schema v2
COBOL record engine for forensic migration workflows. It is not yet a full
COBOL compiler, copybook resolver, or dialect-complete modernization suite.
